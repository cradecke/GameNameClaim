...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean found = myUserDb.IsUserExists(sname);
        if (found==true){
            String message="Profile found";
            String platforms=myUserDb.userPlatform(sname);
            String TargetURL = "/usersearch.jsp";
            MyUtil.PerformAction(message,sname,platforms,TargetURL,request,response);
        }
        else{
